...
public class WaystoneRecipeGenerator extends FabricRecipeProvider {
    public WaystoneRecipeGenerator(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
        ...
        return new RecipeGenerator(wrapperLookup, recipeExporter) {
            ...
            public void generate() {
                for (WaystoneBlockItem item : ModItems.WAYSTONES) {
                    ...
                    createShaped(RecipeCategory.TRANSPORTATION, item, 1)
                            .pattern(" E ")
                            .pattern("RWR")
                            .pattern("BBB")
                            .input('E', Items.ENDER_EYE)
                            .input('R', Items.REDSTONE)
                            .input('W', style.getWall())
                            .input('B', style.getBase())
                            .group("waystone")
